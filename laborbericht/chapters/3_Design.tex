...
Dadurch, dass zwischen den Messpunkten immer $T_M$ gewartet wird, wird der (mit einer Genauigkeit von einer Millisekunde berechnete) Auslösezeitpunkt eventuell nicht exakt erreicht.
Deshalb erfolgt das Aulösen in einem Zeitfenster.
