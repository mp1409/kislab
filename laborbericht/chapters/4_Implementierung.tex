...
\begin{itemize}
	...
	\item \identifier{invalidate()} invaldiert 5 Sensorwerte.
	Diese Methode ist muss jeweils nach dem aktivieren des Servomotors (\identifier{open()} bzw. \identifier{close()} des Release) aufgerufen werden.
\end{itemize}
